...
class benchmarkemaillite_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$fields_labels = array(
			__( 'First Name', 'benchmark-email-lite' ),
			__( 'Last Name', 'benchmark-email-lite' ),
			__( 'Middle Name', 'benchmark-email-lite' ),
			__( 'Address', 'benchmark-email-lite' ),
			__( 'City', 'benchmark-email-lite' ),
			__( 'State', 'benchmark-email-lite' ),
			__( 'Zip', 'benchmark-email-lite' ),
			__( 'Country', 'benchmark-email-lite' ),
			__( 'Phone', 'benchmark-email-lite' ),
			__( 'Fax', 'benchmark-email-lite' ),
			__( 'Cell Phone', 'benchmark-email-lite' ),
			__( 'Company Name', 'benchmark-email-lite' ),
			__( 'Job Title', 'benchmark-email-lite' ),
			__( 'Business Phone', 'benchmark-email-lite' ),
			__( 'Business Fax', 'benchmark-email-lite' ),
			__( 'Business Address', 'benchmark-email-lite' ),
			__( 'Business City', 'benchmark-email-lite' ),
			__( 'Business State', 'benchmark-email-lite' ),
			__( 'Business Zip', 'benchmark-email-lite' ),
			__( 'Business Country', 'benchmark-email-lite' ),
			__( 'Notes', 'benchmark-email-lite' ),
			__( 'Extra 3', 'benchmark-email-lite' ),
			__( 'Extra 4', 'benchmark-email-lite' ),
			__( 'Extra 5', 'benchmark-email-lite' ),
			__( 'Extra 6', 'benchmark-email-lite' ),
		);
		...
		$defaults = array(
			...
			'fields_labels' => array( $fields_labels[0], $fields_labels[1], __( 'Email', 'benchmark-email-lite' ) ),
			'fields_required' => array( 0, 0, 1 ),
			'fields' => array( $fields[0], $fields[1], 'Email' ),
			'filter' => 0,
			'list' => '',
			'page' => '',
